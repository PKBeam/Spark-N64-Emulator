...
export {
    ...
    struct RDRAM_REG_REF_INTERVAL {
        uint32_t : 32;
    };

    struct RDRAM_REG_REF_ROW {
        uint32_t              : 8;
    ...
    struct RDRAM_REG_ADDRESS_SELECT {
        uint32_t               : 16;
    ...
    struct RDRAM_REG_DEVICE_MANUFACTURER {
